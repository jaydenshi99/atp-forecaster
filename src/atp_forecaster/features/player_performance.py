...
def main():
    ...
    df_performance.to_parquet("./data/features/player_performance.parquet", index=True)
    logger.info(f"Player performance calculation completed! Saved {len(df_performance)} rows to ./data/features/player_performance.parquet")
